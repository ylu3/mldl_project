...
netF_rot = RelativeRotationClassifier(input_dim=input_dim_F * 2)
...
for epoch in range(first_epoch, args.epochs + 1):
        ...
        for batch_num, (img_rgb, img_depth, img_label_source) in enumerate(train_loader_source_rec_iter):
            ...
            with OptimizerManager(optims_list):
                ...
                if args.weight_rot > 0.0:
                    ...
                    radian_rot = netF_rot(torch.cat((pooled_rgb, pooled_depth), 1))
                    ...
                    del img_rgb, img_depth, rot_label, pooled_rgb, pooled_depth, radian_rot, loss
                    """
    ...
    if args.weight_rot > 0.0:
        ...
        with EvaluationManager(net_list), tqdm(total=actual_test_batches, desc="Validation Source Rotaion: ") as pb:
            ...
            print("Epoch: {} - Validation source rotation loss: {}".format(epoch, val_loss_rot_source_per_batch))
        ...
        with EvaluationManager(net_list), tqdm(total=actual_test_batches, desc="Validation Target Rotation: ") as pb:
            ...
            print("Epoch: {} - Validation target rotation loss: {}".format(epoch, val_loss_rot_target_per_batch))
